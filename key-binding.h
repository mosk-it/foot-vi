...
enum bind_action_vimode {
    ...
    BIND_ACTION_VIMODE_NEXT_WORD_BEGIN_BIG,
    BIND_ACTION_VIMODE_PREV_WORD_BEGIN_BIG,
    BIND_ACTION_VIMODE_CURSOR_TOP,
    BIND_ACTION_VIMODE_CURSOR_MIDDLE,
    BIND_ACTION_VIMODE_CURSOR_BOTTOM,
    ...
    // f<char> F<char>
    BIND_ACTION_VIMODE_FIND_CHAR_FORWARD,
    BIND_ACTION_VIMODE_FIND_CHAR_BACKWARD,
